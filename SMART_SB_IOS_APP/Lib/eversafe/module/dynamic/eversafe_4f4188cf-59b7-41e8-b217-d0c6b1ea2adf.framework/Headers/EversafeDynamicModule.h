...
@interface EFHP_A19MB7 : NSObject
@property (weak) id<EversafeCoreDelegate> coreDelegate;
- (instancetype)initWithDictionary:(NSDictionary *)dictionary;
@end


#define SEQ_ADDITION_1(seq)

#define SEQ_ADDITION_2(seq) seq += -4043

#define SEQ_ADDITION_3(seq)

#define SEQ_ADDITION_4(seq) seq += -581

#define SEQ_ADDITION_5(seq) seq += 645

#define SEQ_ADDITION_6(seq) seq += 117

#define SEQ_ADDITION_7(seq) seq += 850

#define SEQ_ADDITION_8(seq) seq += -780

#define SEQ_ADDITION_9(seq) seq += 285

#define SEQ_ADDITION_10(seq) seq += 741
